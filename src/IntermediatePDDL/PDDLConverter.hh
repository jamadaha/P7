...
private:
    ...
    static std::unordered_map<unsigned int, std::vector<MultiFact>> GetMultiFacts(PDDLDomain *domain, std::unordered_map<std::string, unsigned int> *objectMap, LiteralList *literalList);
};
