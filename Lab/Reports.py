...
class Reports():
    ...
    def AddPlots(experiment):
        ...
        experiment.add_report(ScatterPlotReport(attributes=['reformulation_time'], matplotlib_options=matplotlib_options), name="Reformulation Time")
