...
class SingleSearchParser(Parser):
    def __init__(self):
        ...
        self.add_function(check_single_search,file=downward_log)
        self.add_function(add_coverage,file=downward_log)
        self.add_function(add_memory,file=downward_log)
        self.add_function(add_initial_h_values,file=downward_log)
        self.add_function(ensure_minimum_times,file=downward_log)
        self.add_function(add_scores,file=downward_log)
