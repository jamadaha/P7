(define (domain gripper)
	...
	(:predicates
		...
		(free ?x) (carry ?x ?y)
		(is-b1 ?x) (is-rooma ?x) (is-left ?x) (is-roomb ?x))
	...
	(:action macro
		:parameters (?x ?y ?z ?v)
		:precondition 	(and (BALL ?x) (ROOM ?y) (GRIPPER ?z) (at-ball ?x ?y) (at-robby ?y) (free ?z) (ROOM ?v) (at-robby ?y)
						(is-b1 ?x) (is-rooma ?y) (is-left ?z) (is-roomb ?v))
		:effect 		(and (at-robby ?y) (at-ball ?x ?v) (not (carry ?z ?x)) ))
)
